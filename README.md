...
American Spanish (`es`) translation of that week's content every Monday,
...
- `issues/` — each week's generated `.docx` newsletter(s) (English and Spanish), plus the
  `content-<date>.json` and `content-<date>-es.json` each was built from.
